        ...
        <div class="benefit inner-benifit inner-benifit3 login-box">
            <div class="container mt-2">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" data-bs-toggle="tab" href="#showAll">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="showAll">
                        <div class="row border g-0 rounded shadow-sm">
                            <div class="col p-4">
                                <form class="form-horizontal"  action="Controller?ShowAll=insert&user=${data[1]}&email=${data[0]}" method="post">
