                    ...
                    <div class="tab-pane active" id="update">
                        <div class="row border g-0 rounded shadow-sm">
                            <div class="col p-4">
                                ...
                                <form class="form-horizontal"  action="Controller?param=update&user=${data[1]}&email=${data[0]}" method="post">
                                    <div class="form-group">
                                        <label >Question Id:</label>
                                        <input type="text" name="questionId1" value="<%=rs.getString(1)%>">
                                    </div>
                                    <div  class="form-group">
                                        <label >Question:</label>
                                        <input type="text" class="form-control" id="question" name="question"  placeholder="Question*" value="<%=rs.getString(2)%>">
                                    </div>
                                    <div  class="form-group">
                                        <label >Option 1:</label>
                                        <input type="text" class="form-control" id="option1" name="option1"  placeholder="Option 1*" value="<%=rs.getString(3)%>">
                                    </div>
                                    <div class="form-group">
                                        <label >Option 2:</label>
                                        <input type="text" class="form-control" id="option2" name="option2"  placeholder="Option 2*" value="<%=rs.getString(4)%>">
                                    </div>
                                    <div  class="form-group">
                                        <label >Option 3:</label>
                                        <input type="text" class="form-control" id="option3" name="option3"  placeholder="Option 3*" value="<%=rs.getString(5)%>">
                                    </div>
                                    <div  class="form-group">
                                        <label >Option 4:</label>
                                        <input type="text" class="form-control" id="option4" name="option4"  placeholder="Option 4*" value="<%=rs.getString(6)%>">
                                    </div>
                                    <div  class="form-group">
                                        <label >Answer:</label>
                                        <input type="text" class="form-control" id="answer" name="answer"  placeholder="Answer *" value="<%=rs.getString(7)%>">
                                    </div>
                                    <div  class="form-group submit-box">
