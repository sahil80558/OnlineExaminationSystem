...
<html>
    <head>
        ...
        <script type="text/javascript">
            function cheakInsertQuestion() {
                a = document.getElementById('questionId').value;
                b = document.getElementById('question').value;
                c = document.getElementById('option1').value;
                d = document.getElementById('option2').value;
                e = document.getElementById('option3').value;
                f = document.getElementById('option4').value;
                g = document.getElementById('answer').value;
                if (a === "" || b === "" || c === "" || d === "" || e === "" || f === "" || g === "") {
                    document.getElementById('valid').innerHTML = "Enter Valid details ";
        ...
        <div class="benefit inner-benifit inner-benifit3 login-box">
            <div class="container mt-2">
                ...
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a class="nav-link active" data-bs-toggle="tab" href="#CSV">
                    ...
                    <div class="tab-pane active" id="CSV">
                        <div class="row border g-0 rounded shadow-sm">
                            <div class="col p-4">
                                ...
                                <div class="col p-4">
                                    <form action="Controller2?param=CSVFile&user=${data[1]}&email=${data[0]}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="tab-pane" id="add">
                        <div class="row border g-0 rounded shadow-sm">
                            <div class="col p-4">
                                ...
                                <form class="form-horizontal"  onsubmit="return cheakInsertQuestion()" action="Controller?param=insert&user=${data[1]}&email=${data[0]}" method="post">
